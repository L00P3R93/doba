<div>
    ...
    <form wire:submit="save" enctype="multipart/form-data">
        ...
        <div class="subheading">Upload Video File</div>
        <input type="file" wire:model="videoFile" name="video_file" class="form-control mb-2" accept="video/*" style="background: rgba(15, 45, 63, 0.5); border: 1px solid rgba(240, 229, 84, 0.3); color: #fff; border-radius: 6px;" required>
        @error('videoFile')
            <div class="text-danger small mb-2">{{ $message }}</div>
        @enderror

        <div class="subheading">Ad Type</div>
        <select wire:model="adType" class="form-select mb-2 select2" style="background: rgba(15, 45, 63, 0.5); border: 1px solid rgba(240, 229, 84, 0.3); color: #fff; border-radius: 6px;" required>
        ...
        <input type="text" wire:model="basePricePerImpression" list="priceOptions" class="form-control mb-2" style="background: rgba(15, 45, 63, 0.5); border: 1px solid rgba(240, 229, 84, 0.3); color: #fff; border-radius: 6px;" required>
        ...
        <button class="btn btn-gold w-100" wire:loading.attr="disabled">
            <span wire:loading.remove>Request Video Ad</span>
