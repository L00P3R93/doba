<div>
    ...
    <form wire:submit="save" enctype="multipart/form-data">
        <div class="subheading">Upload Banner Image</div>
        <input type="file" wire:model="bannerImage" name="banner_image" class="form-control mb-2" accept="image/*" style="background: rgba(15, 45, 63, 0.5); border: 1px solid rgba(240, 229, 84, 0.3); color: #fff; border-radius: 6px;" required>
        @error('banner_image')
        ...
        <input type="text" wire:model="basePricePerImpression" class="form-control mb-2" value="0.2" style="background: rgba(15, 45, 63, 0.5); border: 1px solid rgba(240, 229, 84, 0.3); color: #fff; border-radius: 6px;" required>
        ...
        <button class="btn btn-gold w-100" wire:loading.attr="disabled">
            <span wire:loading.remove>Request Banner Ad</span>
