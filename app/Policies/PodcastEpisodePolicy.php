...
class PodcastEpisodePolicy
{
     ...
     */
    public function update(User $user, PodcastEpisode $podcastEpisode): bool
    {
     ...
     */
    public function delete(User $user, PodcastEpisode $podcastEpisode): bool
    {
     ...
     */
    public function restore(User $user, PodcastEpisode $podcastEpisode): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, PodcastEpisode $podcastEpisode): bool
    {
        return false;
    }
}
